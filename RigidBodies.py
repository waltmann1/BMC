...
class Rigid(object):
    ...
    def set_rigid_bodies(self, system, reinit=None, o_list=None, reset=False, orientations=False):
        ...
        if reinit is not None:
            ...
            return self.rigid
        rigids = 0
        #print(system.particles.get(rigids).type)
        #quit()
